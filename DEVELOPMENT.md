...
```bash
git remote add encore encore://smart-health-drink-vending-irbi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/smart-health-drink-vending-irbi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/smart-health-drink-vending-irbi/settings/integrations/github)
